...
function pcsd_scripts_styles() {
	...
	wp_enqueue_style( 'parent_style', get_template_directory_uri().'/assets/css/employee-parent-styles.css', '', '1.00.01', false);
	wp_enqueue_style( 'style', get_stylesheet_uri(), array('parent_style'), '1.00.01', false);
	wp_enqueue_style('header', get_template_directory_uri() . '/assets/css/header.css', '', '1.0.01', false);
