...
function pcsd_scripts_styles() {
	...
	wp_enqueue_style( 'parent_style', get_template_directory_uri().'/assets/css/employee-parent-styles.css', '', '1.00.15', false);
	...
	if ( is_front_page() ) {
		wp_enqueue_style( 'front_page', get_template_directory_uri() . '/assets/css/frontpage-employee.css', array(),'1.00.07', false);
	}
